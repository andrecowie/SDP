...
function OnGUI () {
     ...
     if (GUI.Button(Rect(10,10,100,50),"action1")){
		animationObject.GetComponent.<Animation>().Play("action1");
     }
     
     if (GUI.Button(Rect(120,10,50,50),"action2")){
		animationObject.GetComponent.<Animation>().Play("action2");
     }
